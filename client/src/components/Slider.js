...
const Slider = () => {
     const SliderData = [
        {
          title: 'Seasonal Boutique',
          subtitle :'Dress according to season.'
        },
        {
            title: 'Delight fashion',
            subtitle :'Fit to your style'
        },
        {
            title: 'The Best Hoodie',
            subtitle :'For the cold season'
        },
        {
            title: 'Fabric singlet',
            subtitle :'Find your delight item in our store.'
        }
      ];
